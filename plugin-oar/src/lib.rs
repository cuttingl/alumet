...
use crate::cgroupv2_probe::CgroupV2prob;
...
impl AlumetPlugin for OARPlugin {
    ...
    fn start(&mut self, alumet: &mut alumet::plugin::AlumetStart) -> anyhow::Result<()> {
        ...
        let final_list_metric_file: Vec<CgroupV2MetricFile> = cgroup_v2::list_all_file(&self.config.path)?;
