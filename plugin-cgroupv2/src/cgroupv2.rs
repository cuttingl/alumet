...
mod tests {
    ...
    fn test_zero_values() {
        ...
        let result_cpu = CgroupMeasurements::from_str(str_cpu).unwrap();
        assert_eq!(result_cpu, expected);

        let result_memory = CgroupMeasurements::from_str(str_memory).unwrap();
        assert_eq!(result_memory, expected);
    }
    ...
    fn test_large_values() {
        let str_cpu = "
            ...
            user_usec 18446744073709551616
            system_usec 18446744073709551616";

        let str_memory = "
            anon 18446744073709551616
            file 18446744073709551616
            kernel_stack 18446744073709551616
            pagetables 18446744073709551616
            percpu 890784
            sock 16384
            shmem 2453504
        ...
        CgroupMeasurements::from_str(str_cpu).expect_err("ERROR : Overflow");
        CgroupMeasurements::from_str(str_memory).expect_err("ERROR : Overflow");
    }
