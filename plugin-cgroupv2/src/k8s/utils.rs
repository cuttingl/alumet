...
mod tests {
    ...
    fn test_list_metric_file_in_dir() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/kubepods-folder.slice/");
    ...
    fn test_gather_value_with_invalid_data() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/kubepods-invalid-gather.slice/");
    ...
    fn test_gather_value_with_valid_values() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/kubepods-gather.slice/");
    ...
    async fn test_get_existing_pods_with_empty_url() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_3/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_3/run/secrets/kubernetes.io/serviceaccount/token_3".to_string());
    ...
    // Test `get_existing_pods` with JSON value send in fake server to a specific token
    #[tokio::test]
    async fn test_get_existing_pods_with_server_request() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_4/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_4/run/secrets/kubernetes.io/serviceaccount/token_4".to_string());
    ...
    async fn test_get_existing_pods_with_url_and_json_error() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_5/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_5/run/secrets/kubernetes.io/serviceaccount/token_5".to_string());
    ...
    async fn test_get_existing_pods_with_cursor_error() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_6/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_6/run/secrets/kubernetes.io/serviceaccount/token_6".to_string());
    ...
    async fn test_get_pod_name_with_valid_token_and_empty_url() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_7/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_7/run/secrets/kubernetes.io/serviceaccount/token_7".to_string());
    ...
    // Test `get_pod_name` with JSON value send in fake server to a specific token and get valid data
    #[tokio::test]
    async fn test_get_pod_name_with_valid_data() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_8/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_8/run/secrets/kubernetes.io/serviceaccount/token_8".to_string());
    ...
    async fn test_get_pod_name_with_url_and_json_error() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_9/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_9/run/secrets/kubernetes.io/serviceaccount/token_9".to_string());
    ...
    async fn test_get_pod_name_with_uid_error() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_10/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_10/run/secrets/kubernetes.io/serviceaccount/token_10".to_string());
    ...
    async fn test_get_pod_name_with_cursor_error() {
        let tmp = std::env::temp_dir();
        let root = tmp.join("test-alumet-plugin-k8s/var_11/");
        ...
        token.path =
            Some("/tmp/test-alumet-plugin-k8s/var_11/run/secrets/kubernetes.io/serviceaccount/token_11".to_string());
